...
We now assess the important cooling processes which take place in Arcturus' atmosphere between $\sim 1-10\,R_{\star}$. 
...
\caption[]{The effect of adiabatic expansion cooling in Arcturus' outflow. The dominant term close to the photosphere is the velocity gradient term from Equation \ref{eq:1.8} due to the rapid wind acceleration, while further out where the wind reaches its terminal velocity, the geometric term becomes dominant.}
\label{fig:7.1}
\end{figure}
