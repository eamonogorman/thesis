...
\begin{figure}[h!]
  \centering
    \includegraphics[width=140mm]{turb.ps}
      \caption{Kolmogorov spectrum: The energy (turbulent energy) spectrum as a function of eddie size $\lambda$ that depends on the 1/3 power of $\lambda$.}
