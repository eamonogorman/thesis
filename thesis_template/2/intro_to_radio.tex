...
\end{split}
\end{equation}
Therefore Equation \ref{eq:visib} can be defined in terms of the coordinate system layed out in Figure \ref{fig2h} as
...
\subsection{Imaging (Inverting the Visibilities)}\label{subsec:x}
